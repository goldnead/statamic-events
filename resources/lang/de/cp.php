...
return [
    ...
    'field_venue_postal_code' => 'PLZ',
    'field_venue_postal_code_instructions' => 'So, wie sie vor Ort geschrieben wird, mit Länderpräfix wie A-1070.',
    'field_venue_city' => 'Stadt',
    'field_venue_country' => 'Land',
    'field_venue_latitude' => 'Breitengrad',
    'field_venue_longitude' => 'Längengrad',
    'field_coordinates_instructions' => 'Dezimalgrad. Wird für Umkreissuche und Karte gebraucht.',
    'section_tickets' => 'Tickets',
    'section_tickets_instructions' => 'Jeder Termin wird einzeln verkauft, darum steht der Link hier und nicht am Event.',
    'field_tickets_url' => 'Ticket-Link',
    'field_is_free' => 'Eintritt frei',
    'field_is_free_instructions' => 'Sag es, sonst liest sich ein fehlender Ticket-Link wie ein vergessener.',
