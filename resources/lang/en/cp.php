...
return [
    ...
    'section_location_geo_instructions' => 'Write the postal code the way it is written locally, including a country prefix such as A-1070. Coordinates in decimal degrees — they are what radius search and the map need.',
    'field_venue_postal_code' => 'Postal code',
    'field_venue_city' => 'City',
    'field_venue_country' => 'Country',
    'field_venue_latitude' => 'Latitude',
    'field_venue_longitude' => 'Longitude',
    'section_tickets' => 'Tickets',
    'section_tickets_instructions' => 'Each date sells separately, so the link belongs here rather than on the event.',
    'field_tickets_url' => 'Ticket link',
    'field_is_free' => 'Admission free',
    'field_is_free_instructions' => 'Say so, otherwise a missing ticket link reads as a forgotten one.',
